...
class Decoder(nn.Module):
    def __init__(self, input_size, hidden_size, dropout, use_act):
...
class LSTMAE(nn.Module):
    def __init__(self, input_size, hidden_size, dropout_ratio, use_act=True):
        ...
        self.decoder = Decoder(input_size=input_size, hidden_size=hidden_size, dropout=dropout_ratio, use_act=use_act)
